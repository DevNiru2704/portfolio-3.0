...
import { seedNow } from '@/config/seed';
import { GridBg } from '@/components/site/grid-bg';
import { SectionHeading } from '@/components/site/section-heading';

const sections = [
  { key: 'building', title: 'Currently building', icon: Rocket, items: seedNow.building },
  { key: 'learning', title: 'Currently learning', icon: BookOpen, items: seedNow.learning },
  { key: 'experimenting', title: 'Currently experimenting', icon: FlaskConical, items: seedNow.experimenting },
];
        ...
        <div className="mt-6 grid gap-5 lg:grid-cols-2">
          <div className="rounded-2xl border border-border bg-card/60 p-6">
            <div className="flex items-center gap-2">
              ...
              <div>
                <div className="font-mono text-[10px] uppercase tracking-[0.22em] text-muted-foreground">current stack obsessions</div>
          ...
          <div className="rounded-2xl border border-border bg-card/60 p-6">
            ...
            <p className="mt-4 text-lg font-medium text-gradient">{seedNow.goal}</p>
          </div>
        </div>
      </section>
    </div>
