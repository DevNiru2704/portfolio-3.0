...
import { seedStack } from '@/config/seed';
...
export function StackOrbit() {
  const layers = Object.keys(seedStack);
  const [active, setActive] = useState(layers[0]);
  const items = seedStack[active];
      ...
      <div className="relative mx-auto aspect-square w-full max-w-[420px]">
        ...
        <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2">
          <div
            ...
            style={{
              boxShadow: `0 0 40px -8px hsl(${layerAccents[active]} / 0.6), inset 0 0 24px -10px hsl(${layerAccents[active]} / 0.45)`,
            }}
          >
            ...
            <span
              ...
              style={{
                background: `conic-gradient(from 0deg, transparent, hsl(${layerAccents[active]} / 0.35), transparent 70%)`,
            ...
            >
              <div className="group relative">
                <div
                  ...
                  style={{ boxShadow: `0 0 12px hsl(${layerAccents[active]} / 0.7)` }}
                />
            ...
            {items.map((it) => (
              <li key={it} className="flex items-center gap-2 text-sm">
                <span
                  ...
                  style={{ background: `hsl(${layerAccents[active]})` }}
                />
                {it}
              </li>
            ))}
